...
```{r street lamps map,  fig.height=6, results='markup'}
...
```{r police grid, results='markup', fig.height= 6 }
...
```{r small multiples, results='markup', fig.height=8}
...
```{r local_morans.plot, fig.width=10, fig.height=6}
...
```{r street lamps nn map, results='markup'}
ggplot() +
...
```{r table print, results='markup', fig.width= 8}
...
```{r plotof errors, results='markup', fig.width=8}
...
```{r map of errors, fig.height=8, results='markup'}
...
```{r race diparity table, results='markup'}
...
```{r kernel density map, results='markup'}
